...
class Enemy(Entity):
    def __init__(self, monster_name, pos, groups, obstacle_sprites, damage_player, triger_death_particles,add_exp):
        ...
        self.hit_sount = pygame.mixer.Sound('audio/hit.wav')
        self.attack_sound = pygame.mixer.Sound(monster_info['attack_sound'])
        self.death_sound.set_volume(0.2)
        self.hit_sount.set_volume(0.2)
    ...
    def get_player_distanse_direction(self, player):
    ...
    def get_status(self, player):
        distance = self.get_player_distanse_direction(player)[0]
    ...
    def get_damage(self, player, attack_type):
        ...
        # self.invincibility_duration = player.cooldawn + weapon_data[player.weapon]['cooldown']
        if self.vulnerable:
            self.hit_sount.play()
            self.direction = self.get_player_distanse_direction(player)[1]
