...
class  AnimationPlayer:
    ...
    def create_grass_particle(self, pos, group):
        animation_sprite = choice(self.frames['leaf'])
        ParticleEffect(pos, animation_sprite, group)

    def create_particle(self, attack_type, pos, group):
        animation_sprite = self.frames[attack_type]
        ParticleEffect(pos, animation_sprite, group)
